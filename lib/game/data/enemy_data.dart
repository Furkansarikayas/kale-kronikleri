...
class EnemyData {
  ...
  static const Map<EnemyType, EnemyStats> _stats = {
    ...
    EnemyType.cavalry: EnemyStats(type: EnemyType.cavalry, name: 'Hızlı Süvari', hp: 20, armor: 0, speed: 2.0, goldReward: 5, castleDamage: 2, difficulty: EnemyDifficulty.easy),
    ...
    EnemyType.healer: EnemyStats(type: EnemyType.healer, name: 'Şifacı', hp: 40, armor: 0, speed: 0.9, goldReward: 8, castleDamage: 2, difficulty: EnemyDifficulty.medium),
    ...
    EnemyType.shadowLord: EnemyStats(type: EnemyType.shadowLord, name: 'Gölge Lord', hp: 500, armor: 0, speed: 0.4, goldReward: 50, castleDamage: 5, difficulty: EnemyDifficulty.boss, isBoss: true),
