...
class EnemyData {
  ...
  static const Map<EnemyType, EnemyStats> _stats = {
    ...
    EnemyType.armoredGiant: EnemyStats(type: EnemyType.armoredGiant, name: 'Zırhlı Dev', hp: 120, armor: 15, speed: 0.5, goldReward: 12, castleDamage: 3, difficulty: EnemyDifficulty.medium),
    EnemyType.undead: EnemyStats(type: EnemyType.undead, name: 'Canlanır Ölü', hp: 60, armor: 0, speed: 0.8, goldReward: 10, castleDamage: 3, difficulty: EnemyDifficulty.medium, splitCount: 3, splitHp: 15),
    EnemyType.shieldBearer: EnemyStats(type: EnemyType.shieldBearer, name: 'Kalkan Taşıyıcı', hp: 50, armor: 25, speed: 0.7, goldReward: 10, castleDamage: 3, difficulty: EnemyDifficulty.medium),
    EnemyType.healer: EnemyStats(type: EnemyType.healer, name: 'Şifacı', hp: 40, armor: 0, speed: 0.9, goldReward: 12, castleDamage: 3, difficulty: EnemyDifficulty.medium),
    EnemyType.burrower: EnemyStats(type: EnemyType.burrower, name: 'Yeraltı Solucanı', hp: 70, armor: 10, speed: 1.0, goldReward: 15, castleDamage: 4, difficulty: EnemyDifficulty.hard),
    EnemyType.troll: EnemyStats(type: EnemyType.troll, name: 'Trol', hp: 150, armor: 5, speed: 0.6, goldReward: 18, castleDamage: 4, difficulty: EnemyDifficulty.hard),
    EnemyType.darkKnight: EnemyStats(type: EnemyType.darkKnight, name: 'Karanlık Şövalye', hp: 100, armor: 20, speed: 1.2, goldReward: 20, castleDamage: 5, difficulty: EnemyDifficulty.hard),
    EnemyType.shadowLord: EnemyStats(type: EnemyType.shadowLord, name: 'Gölge Lord', hp: 500, armor: 10, speed: 0.4, goldReward: 50, castleDamage: 8, difficulty: EnemyDifficulty.boss, isBoss: true),
    EnemyType.dragonEmperor: EnemyStats(type: EnemyType.dragonEmperor, name: 'Ejderha İmparatoru', hp: 800, armor: 0, speed: 0.3, goldReward: 100, castleDamage: 10, difficulty: EnemyDifficulty.boss, isBoss: true),
  };
